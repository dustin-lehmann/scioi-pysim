...
plt.plot(agent1_cilc.ilc.e_norm, label='Agent 1 (CILC)', color='darkorange', **twipr_ilc.e_norm_plot_options)
plt.plot(agent2_baseline.ilc.e_norm, label='Agent 2 (individual)', color='lightgreen', **twipr_ilc.e_norm_plot_options)
plt.plot(agent2_cilc.ilc.e_norm, label='Agent 2 (CILC)', color='darkgreen', **twipr_ilc.e_norm_plot_options)
plt.plot(agent3_baseline.ilc.e_norm, label='Agent 3 (individual)', color='lightblue', **twipr_ilc.e_norm_plot_options)
plt.plot(agent3_cilc.ilc.e_norm, label='Agent 3 (CILC)', color='darkblue', **twipr_ilc.e_norm_plot_options)

# plt.plot(enorm_ecilc, label='ECILC', color='red')
plt.plot(enorm_cilc, label='CILC', color='black')
plt.xlabel("Trial $j$")
plt.ylabel("Error norm $||\mathbf{e}||_2$")
plt.xticks(ticks=agent1.ilc.e_norm.t)
plt.yscale('log')
plt.ylim(bottom=0.5, top=12)
