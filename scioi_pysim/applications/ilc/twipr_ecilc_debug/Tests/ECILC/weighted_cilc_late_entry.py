...
config_1 = twipr_ilc.config_1 | {'entry_trial': 5, 'step_1_function': test_fun_1, 'step_2_function': test_fun_2}
config_2 = twipr_ilc.config_2 | {'entry_trial': 0, 'step_1_function': test_fun_1, 'step_2_function': test_fun_2}
config_3 = twipr_ilc.config_3 | {'entry_trial': 10, 'step_1_function': test_fun_1, 'step_2_function': test_fun_2}
...
plt.xlabel("Trial $j$")
plt.title("Approach 2: Weighted CILC (late entry)")
