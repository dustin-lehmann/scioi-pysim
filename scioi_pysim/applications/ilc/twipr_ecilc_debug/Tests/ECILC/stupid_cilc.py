...
def test_fun_1(agent: twipr_ecilc.TWIPR_2D_ECILC_Agent, agents):
    if agent.active:
        agent.weight = agent.ilc.trials[-1].e_norm
...
config_1 = twipr_ilc.config_1 | {'entry_trial': 10, 'step_1_function': test_fun_1, 'step_2_function': test_fun_2}
config_2 = twipr_ilc.config_2 | {'entry_trial': 20, 'step_1_function': test_fun_1, 'step_2_function': test_fun_2}
...
plt.xlabel("Trial $j$")
plt.title("Approach 4: Worst performer weighted CILC (late entry)")
