...
from scioi_py_core.core.obstacles import CuboidObstacle_3D, Obstacle, TestbedFloor, FloorTile, Wall
...
def main():
    ...
    obstacle1 = CuboidObstacle_3D(name='Obstacle 1', size_x=0.1, size_y=0.1, size_z=0.1, position=[0, 0, 0],
                                  world=env.world)
    obstacle2 = CuboidObstacle_3D(name='Obstacle 2', size_x=0.1, size_y=0.1, size_z=0.1, position=[0.5, 0, 0],
                                  world=env.world)
    obstacle3 = CuboidObstacle_3D(name='Obstacle 3', size_x=0.1, size_y=0.1, size_z=0.1, position=[1, 0, 0],
                                  world=env.world)

    wall1 = Wall(name='Wall 1', position=[2.5, 1.6, 0.0], lenght=2, size_z=0.1, world=env.world)
