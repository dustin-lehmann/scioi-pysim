...
from EnvironmentDustin.Environment.EnvironmentTWIPR_objects import TankRobotSimObject
...
class Environment_SingleTWIPR(EnvironmentBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.obstacle1 = CuboidObstacle_3D(name='Obstacle 1', world=self.world, position=[1, 0, 0], size_x=0.75,
                                           size_y=0.5, size_z=0.25)
    ...
    def action_input(self, *args, **kwargs):
        ...
        self.agent1.state['pos']['x'] = random.uniform(-2.5, 2.5)
        self.agent1.state['pos']['y'] = random.uniform(-2.5, 2.5)
